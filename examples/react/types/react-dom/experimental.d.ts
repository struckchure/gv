...
import React = require("https://esm.sh/@types/react@19.1.0/index.d.ts");
import ReactDOM = require("./canary.d.ts");
...
declare module "https://esm.sh/@types/react@19.1.0/index.d.ts" {
