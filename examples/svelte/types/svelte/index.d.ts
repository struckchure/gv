declare module "svelte" {
   ...
   * ```
   */
  export type ComponentType<Comp extends SvelteComponent = SvelteComponent> =
    (new (
   ...
   * */
  export function createRawSnippet<Params extends unknown[]>(
...
declare module "svelte/legacy" {
   ...
   *
   * */
  export function asClassComponent<
    Props extends Record<string, any>,
    Exports extends Record<string, any>,
    Events extends Record<string, any>,
    Slots extends Record<string, any>
...
declare module "svelte/motion" {
  ...
  export class Tween<T> {
    ...
    static of<U>(
      fn: () => U,
      options?: TweenedOptions<U> | undefined
    ): Tween<U>;
